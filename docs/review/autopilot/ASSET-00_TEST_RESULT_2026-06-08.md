# ASSET-00 Test Result 2026-06-08
...
- Godot printed the known macOS `get_system_ca_certificates` nonfatal error and expected warning-path output from existing tests.
