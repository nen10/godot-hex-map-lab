...
- Existing editor test warnings for intentionally invalid adjacency/source/mask fixtures. These occurred inside passing tests and are unrelated to this docs-only inventory task.
