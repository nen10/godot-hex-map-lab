# SAMPLE-10 Test Result 2026-06-08

## Commands

```sh
/Applications/Godot.app/Contents/MacOS/Godot --headless --log-file .godot_user/test-runs/sample10-editor.log --path . --script res://tests/test_editor_plugin.gd
./tools/test.sh
```
