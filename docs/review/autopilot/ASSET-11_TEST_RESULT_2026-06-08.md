# ASSET-11 Test Result 2026-06-08

## Commands

```sh
/Applications/Godot.app/Contents/MacOS/Godot --headless --log-file .godot_user/test-runs/asset11-editor.log --path . --script res://tests/test_editor_plugin.gd
./tools/test.sh
```
...
- Targeted editor run passed after the context signal repair.
