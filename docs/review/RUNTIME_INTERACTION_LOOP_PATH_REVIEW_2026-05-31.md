...
`docs/plan/RUNTIME_INTERACTION_LOOP_PATH_POLICY_2026-05-31.md` および `docs/plan/RUNTIME_INTERACTION_LOOP_PATH_IMPLEMENTATION_PLAN_2026-05-31.md` の要件に対する commit `326e65d`。
