...
| `REPAIR-11_GRAPH_RESULT_MULTI_OVERLAY_CONTRACT` | `COMPLETE` | [REPAIR-11](./REPAIR-11_GRAPH_RESULT_MULTI_OVERLAY_CONTRACT/CODEX_HANDOFF.md) | `Result = 1 terrain + overlay_0..2` 契約 |
...
| `REPAIR-15_OLD_GENERATE_STATE_MIGRATION_AUDIT` | `BACKLOG` | [REPAIR-15](./REPAIR-15_MARKOV_ADJACENCY_MAPPING/SUB_TASKS.md) | 旧Generateタブからの状態管理移行 全体監査 + 最適UI設計（limited count / symmetric scan / markov・adjacency parity を内包） |
