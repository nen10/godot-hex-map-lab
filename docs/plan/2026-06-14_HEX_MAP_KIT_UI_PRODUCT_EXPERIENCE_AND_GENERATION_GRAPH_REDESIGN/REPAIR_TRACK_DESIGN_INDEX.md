...
| `REPAIR-11_GRAPH_RESULT_MULTI_OVERLAY_CONTRACT` | `READY` | [REPAIR-11](./REPAIR-11_GRAPH_RESULT_MULTI_OVERLAY_CONTRACT/SUB_TASKS.md) | `Result = 1 terrain + N overlay` 契約 |
...
| `REPAIR-14_GRAPH_CANVAS_EDGE_DELETE` | `BACKLOG` | [REPAIR-14](./REPAIR-14_GRAPH_CANVAS_EDGE_DELETE/SUB_TASKS.md) | edge deletion interaction |
...
2. `Result`、複数 overlay、`Compose` の扱いを相談するなら [REPAIR-11](./REPAIR-11_GRAPH_RESULT_MULTI_OVERLAY_CONTRACT/SUB_TASKS.md) と [NODE_ADD_ROW_AND_PORT_CONTRACT](./REPAIR-13_GRAPH_WIDE_STATE_AND_FILTER_SPLIT/NODE_ADD_ROW_AND_PORT_CONTRACT.md)。
...
| 論点 | 主担当 queue | 備考 |
|---|---|---|
| overlay 合成順序 | `REPAIR-11` | 明示 slot / 並べ替え UI / deterministic order |
