...
| `GEN-81` | `COMPLETE` | `GEN-80` | `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/GEN-81_GENERATION_PROFILE_AND_RESULT_MODEL/` | Generation Profile / Result / Document model | generation profile/result docs, resource/API notes, tests if schema changes | Generate preview, intermediate, and committed document states are defined and aligned with QA, Seed Lab, and Document metadata; graph editor remains out of scope. |
...
### ASSET-30 Strict ResourcePicker type filters

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/ASSET-30_STRICT_RESOURCE_TYPE_FILTERS/`
  review: `docs/review/autopilot/ASSET-30_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
...
### TAB-51 Paint tab as real brush workspace

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/TAB-51_PAINT_TAB_REAL_BRUSH_WORKSPACE/`
  review: `docs/review/autopilot/TAB-51_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_workspace_component_registry.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/review/autopilot/TAB-51_TEST_RESULT_2026-06-08.md`

### TAB-52 Catalog tab detail editor

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/TAB-52_CATALOG_TAB_DETAIL_EDITOR/`
  review: `docs/review/autopilot/TAB-52_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
...
### TAB-54 Validate tab issue navigator

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/TAB-54_VALIDATE_TAB_ISSUE_NAVIGATOR/`
  review: `docs/review/autopilot/TAB-54_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    - `addons/hex_map_kit/editor/hex_map_workspace.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/review/autopilot/TAB-54_TEST_RESULT_2026-06-08.md`

### TAB-55 QA tab Seed Lab screen

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/TAB-55_QA_TAB_SEED_LAB_SCREEN/`
  review: `docs/review/autopilot/TAB-55_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_workspace_component_registry.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/review/autopilot/TAB-55_TEST_RESULT_2026-06-08.md`

### TAB-56 Export tab purpose redesign

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/TAB-56_EXPORT_TAB_PURPOSE_REDESIGN/`
  review: `docs/review/autopilot/TAB-56_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
...
### PERF-60 Generate/global update performance profile

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/PERF-60_GENERATE_GLOBAL_UPDATE_PROFILE/`
  review: `docs/review/autopilot/PERF-60_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  ...
  major files:
    - `docs/review/roadmap/GENERATE_UPDATE_PERFORMANCE_PROFILE_2026-06-08.md`
    - `docs/review/autopilot/PERF-60_TEST_RESULT_2026-06-08.md`

### PERF-61 Progress and busy UI

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/PERF-61_PROGRESS_AND_BUSY_UI/`
  review: `docs/review/autopilot/PERF-61_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
...
### INFO-71 Tab purpose and empty states

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/INFO-71_TAB_PURPOSE_EMPTY_STATES/`
  review: `docs/review/autopilot/INFO-71_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
...
### GEN-81 Generation Profile / Result / Document model

proof:
  plan: `docs/plan/2026-06-08_UI_WORKSPACE_RESOURCE_FLOW_REDESIGN/GEN-81_GENERATION_PROFILE_AND_RESULT_MODEL/`
  review: `docs/review/autopilot/GEN-81_SELF_REVIEW_2026-06-08.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
