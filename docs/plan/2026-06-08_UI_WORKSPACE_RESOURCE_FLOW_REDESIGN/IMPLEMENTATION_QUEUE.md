...
Current recommended next task: `TAB-56`.
...
- `TAB-54` is complete.
- `TAB-55` is complete.
- `TAB-56` is the first READY task in queue order.
- `TAB-57`, `PERF-60`, `INFO-70`, `INFO-71`, and `GEN-80` are also READY, but they appear later in the queue.
