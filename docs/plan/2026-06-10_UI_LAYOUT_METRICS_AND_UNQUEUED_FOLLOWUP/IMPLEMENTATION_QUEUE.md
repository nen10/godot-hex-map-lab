...
Current recommended next task: `DOC-NEXT-90`.
...
Proof entries live in `PROOF_LOG.md` (kept separate to keep this queue lean for
executor context). Append new `### <TASK-ID>` proof entries there, not here.
