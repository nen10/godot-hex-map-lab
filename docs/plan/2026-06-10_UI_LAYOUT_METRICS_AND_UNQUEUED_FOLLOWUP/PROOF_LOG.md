...
Companion to `IMPLEMENTATION_QUEUE.md` (this is its section 10, kept separate so
the queue stays lean for executor context windows). Append new `### <TASK-ID>`
proof entries here when a task completes.
...
proof:
  plan: `docs/plan/2026-06-10_UI_LAYOUT_METRICS_AND_UNQUEUED_FOLLOWUP/DOC-NEXT-90_MANUAL_AND_PROCESS_UPDATE/`
  review: `docs/review/autopilot/DOC-NEXT-90_SELF_REVIEW_2026-06-14.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
    ...
    - `README.md`
  major files:
    - `docs/plan/2026-06-10_UI_LAYOUT_METRICS_AND_UNQUEUED_FOLLOWUP/DOC-NEXT-90_MANUAL_AND_PROCESS_UPDATE/SUB_TASKS.md`
    - `docs/plan/2026-06-10_UI_LAYOUT_METRICS_AND_UNQUEUED_FOLLOWUP/DOC-NEXT-90_MANUAL_AND_PROCESS_UPDATE/UX.md`
    - `docs/plan/2026-06-10_UI_LAYOUT_METRICS_AND_UNQUEUED_FOLLOWUP/DOC-NEXT-90_MANUAL_AND_PROCESS_UPDATE/POLICY.md`
