...
1. Generative Reference ItemKey
   ...
   - 詳細: `docs/plan/GENERATIVE_REFERENCE_ITEMKEY_IMPLEMENTATION_PLAN_2026-05-31.md`
2. Query Row offset graphical control
   - 方針: `docs/plan/QUERY_ROW_OFFSET_GRAPHICAL_CONTROL_POLICY_2026-05-31.md`
   - 詳細: `docs/plan/QUERY_ROW_OFFSET_GRAPHICAL_CONTROL_IMPLEMENTATION_PLAN_2026-05-31.md`
3. Crop保持再計算モード
...
4. Runtime click / loop path / connected component helper
   ...
   - 詳細: `docs/plan/RUNTIME_INTERACTION_LOOP_PATH_IMPLEMENTATION_PLAN_2026-05-31.md`
5. マップのマニュアル編集tool
   - 方針: `docs/plan/MANUAL_MAP_EDITING_TOOL_POLICY_2026-05-31.md`
   - 詳細: `docs/plan/MANUAL_MAP_EDITING_TOOL_IMPLEMENTATION_PLAN_2026-05-31.md`
