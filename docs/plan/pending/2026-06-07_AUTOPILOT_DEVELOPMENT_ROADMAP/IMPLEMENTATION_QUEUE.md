...
| `APDEV-11` | `BACKLOG` | `APDEV-10` | `docs/plan/2026-06-07_AUTOPILOT_DEVELOPMENT_ROADMAP/APDEV-11_EDITOR_FEATURE_TEST_SPLIT/` | Feature-specific editor test split | `tests/test_editor_catalog_ui.gd`, `tests/test_editor_validation_dashboard.gd`, `tests/test_editor_object_placement_ui.gd`, `tests/test_editor_generation_qa_ui.gd`, `docs/development_log/2026-06-14_TEST_CREATION_LOG.md` | Feature-specific tests cover the extracted panels; `tests/test_editor_plugin.gd` remains shared plugin smoke/integration coverage | `HEADLESS_TEST_COMPLETE` |
