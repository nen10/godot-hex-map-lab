...
| `SCREEN-20` | `COMPLETE` | `SCREEN-10`, `UI-01` | `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/` | Catalog editing controls moved out of Paint | Catalog tab/screen, Paint tab, catalog resource UI/tests | Catalog tab owns entry list, tile/scene preview, tags/status, create/edit entry, and catalog validation; Paint consumes catalog key and does not expose raw source_id/atlas coords as primary UI; `./tools/test.sh` passed. |
| `SCREEN-21` | `COMPLETE` | `SCREEN-10` | `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/` | Layer, Document, and Export controls moved to responsible tabs | Paint tab, Layers tab, Resources tab, Export tab, editor tests | Layer roles live in Layers; document save/dependency/dirty state lives in Resources; export destination/type lives in Export; Paint has no non-paint responsibility controls; `./tools/test.sh` passed. |
...
- `SCREEN-20` is complete.
- `SCREEN-21` is complete.
...
### UI-02 Settings label simplification

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/UI-02_SETTINGS_LABEL_SIMPLIFICATION/`
  review: `docs/review/autopilot/UI-02_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_workspace.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/UI-02_SETTINGS_LABEL_SIMPLIFICATION/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/UI-02_SETTINGS_LABEL_SIMPLIFICATION/UX.md`
...
### SCREEN-20 Catalog controls out of Paint

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/`
  review: `docs/review/autopilot/SCREEN-20_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_edit_tool.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/UX.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/POLICY.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-20_CATALOG_CONTROLS_OUT_OF_PAINT/IMPLEMENTATION_PLAN.md`
    - `docs/review/autopilot/SCREEN-20_TEST_RESULT_2026-06-10.md`

### SCREEN-21 Layer Document Export controls out of Paint

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/`
  review: `docs/review/autopilot/SCREEN-21_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_edit_tool.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/UX.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/POLICY.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-21_LAYER_DOCUMENT_EXPORT_CONTROLS_OUT_OF_PAINT/IMPLEMENTATION_PLAN.md`
    - `docs/review/autopilot/SCREEN-21_TEST_RESULT_2026-06-10.md`

### SCREEN-22 Paint tab brush surface

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-22_PAINT_TAB_BRUSH_SURFACE/`
  review: `docs/review/autopilot/SCREEN-22_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_edit_tool.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-22_PAINT_TAB_BRUSH_SURFACE/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-22_PAINT_TAB_BRUSH_SURFACE/UX.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-22_PAINT_TAB_BRUSH_SURFACE/POLICY.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-22_PAINT_TAB_BRUSH_SURFACE/IMPLEMENTATION_PLAN.md`
    - `docs/review/autopilot/SCREEN-22_TEST_RESULT_2026-06-10.md`

### SCREEN-23 Validate issue navigator refinement

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-23_VALIDATE_ISSUE_NAVIGATOR_REFINEMENT/`
  review: `docs/review/autopilot/SCREEN-23_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `addons/hex_map_kit/editor/hex_map_edit_tool.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-23_VALIDATE_ISSUE_NAVIGATOR_REFINEMENT/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-23_VALIDATE_ISSUE_NAVIGATOR_REFINEMENT/UX.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-23_VALIDATE_ISSUE_NAVIGATOR_REFINEMENT/POLICY.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-23_VALIDATE_ISSUE_NAVIGATOR_REFINEMENT/IMPLEMENTATION_PLAN.md`
    - `docs/review/autopilot/SCREEN-23_TEST_RESULT_2026-06-10.md`

### SCREEN-24 QA Seed Lab and Generation Profile screen

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-24_QA_SEED_LAB_AND_PROFILE_SCREEN/`
  review: `docs/review/autopilot/SCREEN-24_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    - `addons/hex_map_kit/editor/hex_map_workspace.gd`
    - `tests/test_editor_plugin.gd`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-24_QA_SEED_LAB_AND_PROFILE_SCREEN/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/SCREEN-24_QA_SEED_LAB_AND_PROFILE_SCREEN/UX.md`
...
### PERF-60 Generate performance budget and chunked apply review

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/PERF-60_GENERATE_PERFORMANCE_BUDGET_AND_CHUNKED_APPLY_REVIEW/`
  review: `docs/review/autopilot/PERF-60_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  ...
  major files:
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/PERF-60_GENERATE_PERFORMANCE_BUDGET_AND_CHUNKED_APPLY_REVIEW/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/PERF-60_GENERATE_PERFORMANCE_BUDGET_AND_CHUNKED_APPLY_REVIEW/UX.md`
...
### TEST-80 Editor test file split and state contracts

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/TEST-80_EDITOR_TEST_FILE_SPLIT_AND_STATE_CONTRACTS/`
  review: `docs/review/autopilot/TEST-80_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/TEST.md`
  major files:
    ...
    - `tests/test_editor_plugin.gd`
    - `tools/test.sh`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/TEST-80_EDITOR_TEST_FILE_SPLIT_AND_STATE_CONTRACTS/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/TEST-80_EDITOR_TEST_FILE_SPLIT_AND_STATE_CONTRACTS/UX.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/TEST-80_EDITOR_TEST_FILE_SPLIT_AND_STATE_CONTRACTS/POLICY.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/TEST-80_EDITOR_TEST_FILE_SPLIT_AND_STATE_CONTRACTS/IMPLEMENTATION_PLAN.md`
    - `docs/review/autopilot/TEST-80_TEST_RESULT_2026-06-10.md`

### DOC-90 Workspace workflow manual update

proof:
  plan: `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/DOC-90_WORKSPACE_WORKFLOW_MANUAL_UPDATE/`
  review: `docs/review/autopilot/DOC-90_SELF_REVIEW_2026-06-10.md`
  tests:
    - `./tools/test.sh`
  docs:
    - `docs/manual/MANUAL_EDITOR_PLUGIN.md`
    ...
    - `docs/TEST.md`
  major files:
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/DOC-90_WORKSPACE_WORKFLOW_MANUAL_UPDATE/SUB_TASKS.md`
    - `docs/plan/2026-06-10_FEEDBACK_INTEGRATED_RESOURCE_STATE_WORKSPACE_REFACTOR/DOC-90_WORKSPACE_WORKFLOW_MANUAL_UPDATE/UX.md`
