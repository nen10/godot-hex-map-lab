...
- `RES-10` is complete.
- `RES-11` is complete.
- `NODE-20`, `PROFILE-30`, and `STATE-00` are READY.
- `NODE-20` is first in queue order and builds selected-node binding on top of dependency hydration.
